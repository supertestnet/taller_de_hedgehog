var hedgehog_workshop = {
    ...
    stateLoop: async ( auto = true ) => {
        ...
        var i; for ( i=0; i<Object.keys( hedgehog.state ).length; i++ ) {
            ...
            var channel_balance = hedgehog.state[ chan_id ].alices_privkey ? hedgehog.state[ chan_id ].balances[ 0 ] || 0 : hedgehog.state[ chan_id ].balances[ 1 ] || 0;
            if ( channel_is_confirmed ) confirmed_hh_balance = confirmed_hh_balance + channel_balance;
            else unconfirmed_hh_balance = unconfirmed_hh_balance + channel_balance;
        ...
        hedgehog_workshop.confirmed_L2_balance = confirmed_hh_balance;
        hedgehog_workshop.unconfirmed_L2_balance = unconfirmed_hh_balance;
        $( '.confirmed_hedgehog_balance' ).innerText = confirmed_hh_balance.toLocaleString();
        $( '.unconfirmed_hedgehog_balance' ).innerText = unconfirmed_hh_balance.toLocaleString();
